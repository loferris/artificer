  ...
  if (error) {
    return (
      <div className={errorClass}>
        <div className={isTerminal ? themeClasses.accentError : "text-red-600"}>$ cost_tracker --status</div>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-1">
        <span className={isTerminal ? themeClasses.textMuted : "text-gray-500"}>$ cost_tracker --summary</span>
        <button
          onClick={() => refresh()}
      ...
      <div className="space-y-1">
        <div className="flex justify-between">
          <span className={isTerminal ? themeClasses.textSecondary : "text-gray-600"}>total_cost:</span>
        ...
        <div className="flex justify-between">
          <span className={isTerminal ? themeClasses.textSecondary : "text-gray-600"}>messages:</span>
          <span className={isTerminal 
      ...
      {isLoading && (
        <div className={`mt-2 ${isTerminal ? themeClasses.textMuted : 'text-gray-500'} animate-pulse`}>
          Loading stats...
        </div>
      )}
    </div>
