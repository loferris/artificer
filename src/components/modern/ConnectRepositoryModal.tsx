          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-auto p-6">
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <a
                  href={`/api/auth/github/authorize?projectId=${projectId}`}
                  className="w-full px-4 py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-colors flex items-center justify-center space-x-3"
                >
                ...
                <a
                  href={`/api/auth/gitlab/authorize?projectId=${projectId}`}
                  className="w-full px-4 py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors flex items-center justify-center space-x-3"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="font-semibold">Connect with GitLab</span>
                </a>
                <p className="text-xs text-gray-500 text-center mt-2">
                  OAuth provides automatic token management and better security
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-500">OR use Personal Access Token</span>
                </div>
              </div>
