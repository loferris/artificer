...
import { SourceAttribution } from '@/components/worldbuilder/chat/SourceAttribution'
import { Button } from '@/components/ui/button'
import type { Source } from '@/components/worldbuilder/chat/SourceAttribution'
import type { ValidationResult, Operation } from '@artificer/worldbuilder'

// Lazy load heavy components
const ValidationPanel = dynamic(() => import('@/components/worldbuilder/validation/ValidationPanel').then(mod => ({ default: mod.ValidationPanel })), {
  loading: () => <div className="p-8 text-center text-gray-500">Loading validation...</div>
})
const OperationsList = dynamic(() => import('@/components/worldbuilder/operations/OperationsList').then(mod => ({ default: mod.OperationsList })), {
  loading: () => <div className="p-8 text-center text-gray-500">Loading operations...</div>
})
const OperationDiff = dynamic(() => import('@/components/worldbuilder/operations/OperationDiff').then(mod => ({ default: mod.OperationDiff })), {
  loading: () => <div className="p-8 text-center text-gray-500">Loading diff...</div>
})
const WorldExportDialog = dynamic(() => import('@/components/worldbuilder/utilities/WorldExportDialog').then(mod => ({ default: mod.WorldExportDialog })), {
  loading: () => <div>Loading...</div>
})

/**
 * Worldbuilder Component Demo Page
 *
 * Demonstrates all Worldbuilder components for worldbuilding AI applications
 */
export default function WorldbuilderDemoPage() {
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Worldbuilder Component Library
          </h1>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-gray-600">Code Reused from Translator</div>
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <div>
                <span className="font-medium">Tier 1 (Atomic):</span> Badge, Card, Progress, Button, Dialog (from Translator)
              </div>
              <div>
                <span className="font-medium">Tier 2 (Molecular):</span> StatusBadge, BadgeGroup, ExpandableSection, CopyButton (from Translator)
              </div>
              <div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div>
                <span className="font-medium">Reused from Translator:</span> time-utils, diff-engine, cn, componentLogger
              </div>
              <div>
        ...
        <div className="text-center text-gray-600 text-sm">
          <p>
            Built with ❤️ for Worldbuilder • See{' '}
            <code className="bg-gray-100 px-2 py-1 rounded">docs/worldbuilder-component-architecture.md</code>
